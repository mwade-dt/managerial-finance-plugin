...
Copy-Item -Recurse -Path (Join-Path $root "scripts") -Destination (Join-Path $staging "scripts")
Copy-Item -Path (Join-Path $root "Install Addin.bat") -Destination (Join-Path $staging "Install Addin.bat")
Copy-Item -Path (Join-Path $root "Uninstall Addin.bat") -Destination (Join-Path $staging "Uninstall Addin.bat")
